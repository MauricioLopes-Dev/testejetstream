<nav x-data="{ open: false, darkMode: localStorage.theme === 'dark' || (!('theme' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches) }" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-2 lg:space-x-4 sm:-my-px sm:ml-6 sm:flex items-center">
                    
                    <x-nav-link href="{{ route('admin.dashboard') }}" :active="request()->routeIs('admin.dashboard')" class="font-orbitron text-xs lg:text-sm text-slate-600 dark:text-gray-300 hover:text-ellas-purple dark:hover:text-ellas-cyan">
                        Dashboard
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white dark:bg-ellas-card border-t border-gray-100 dark:border-ellas-nav">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('admin.dashboard') }}" :active="request()->routeIs('admin.dashboard')" class="dark:text-gray-300 dark:hover:text-ellas-cyan dark:hover:bg-ellas-nav">
                Dashboard
